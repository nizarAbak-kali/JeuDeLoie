/**
 * \file editer.c
 * \brief Fichier principal de la partie édition.
...
/*Permet de trouver le 1er nom disponible pour une carte a partir de zero
  le nom d'une carte est "unnombre".txt donc j'ai juste besion d'avoir le nombre et j'aurais le nom complet
*/
...
void creation(SDL_Surface *ecran,int*nb)
{
 ...
 menu:
  ...
  /* j'ai affiché le 1e message maintenant, j'affiche un nouveau et change les position*/
  posmsg.x=0;
  posmsg.y=450;
  ...
  /* j'ai affiché le 2e message maintenant, j'affiche un nouveau et change les position*/
  posmsg.x=0;
  posmsg.y=470;
  ...
  /* j'ai affiché le 3e message maintenant,j'affiche un nouveau et change les position*/
  posmsg.x=0;
  posmsg.y=490;
  ...
  /* j'ai affiché le 4e message maintenant, j'affiche un nouveau et change les position*/
  posmsg.x=0;
  posmsg.y=510;
  ...
  /* j'ai affiché le 5e message maintenant, j'affiche un nouveau et change les position*/
  posmsg.x=0;
  posmsg.y=530;
  ...
  /* j'ai affiché le 6e message maintenant,j'affiche un nouveau et change les position*/
  posmsg.x=0;
  posmsg.y=550;
  ...
  /* j'ai affiché le 7e message maintenant,j'affiche un nouveau et change les position*/
  posmsg.x=0;
  posmsg.y=570;
  ...
  while(continuer)
	...
	/*i et j sert a donné la position de la case noir qui se déplace dans le quadrillage que j'appel fantome*/
...
void visualisation_Suppression(SDL_Surface* ecran,int *nb){
 ...
 if(*nb==0)
  ...
  if(nbcartemax>0){//il faut au minimun une carte
    suiv=nb_Parcours(nbcarte);//la carte numero "nbcarte"
